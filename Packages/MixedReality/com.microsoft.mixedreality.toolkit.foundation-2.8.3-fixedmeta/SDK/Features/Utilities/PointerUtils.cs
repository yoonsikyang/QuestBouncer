...
namespace Microsoft.MixedReality.Toolkit.Input
{
    public static class PointerUtils
    {
        ...
        public static T GetPointer<T>(Handedness handedness) where T : class, IMixedRealityPointer
        {
            ...
            foreach (var pointer in focusProvider.GetPointers<T>())
            {
        ...
        {
            if (TryGetPointerPreferences(out IPointerPreferences pointerPreferences))
            {
        ...
        {
            if (TryGetPointerPreferences(out IPointerPreferences preferences))
            {
                preferences.SetPointerBehavior<T>(handedness, sourceType, pointerBehavior);
            }
        }

        private static bool TryGetPointerPreferences(out IPointerPreferences pointerPreferences)
        {
            ...
            pointerPreferences = inputSystem.FocusProvider as IPointerPreferences;
