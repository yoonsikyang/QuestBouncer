...
namespace Microsoft.MixedReality.GraphicsTools
{
    ...
    /// Version=0.1.0
    /// </summary>
    public class CanvasMaterialAnimatorCanvasRadialSpinner : CanvasMaterialAnimatorBase
    {
        ...
        /// Shader property.
        /// </summary>;
        [Range(0f, 1f)] public float _Cycle_Rate_ = 0.7f;
        /// <summary>
        /// Shader property ID.
        /// </summary>
        ...
        /// Shader property.
        /// </summary>;
        [Range(0f, 1f)] public float _Rate_Vary_ = 0.6f;
        /// <summary>
        /// Shader property ID.
        /// </summary>
        ...
        /// Shader property.
        /// </summary>;
        [Range(0f, 1f)] public float _Fill_Vary_ = 1f;
        /// <summary>
        /// Shader property ID.
        /// </summary>
        ...
        /// Shader property.
        /// </summary>;
        [Range(0f, 10f)] public float _Cycle_Offset_ = 0f;
        /// <summary>
        /// Shader property ID.
        /// </summary>
        ...
        /// Shader property.
        /// </summary>;
        public Color _Circle_Color_ = Color.white;
        /// <summary>
        /// Shader property ID.
        /// </summary>
        public static int _Circle_Color_ID = Shader.PropertyToID("_Circle_Color_");
        /// <summary>
        /// Shader property.
        /// </summary>;
        ...
        /// Shader property.
        /// </summary>;
        [Range(0f, 1f)] public float _Circle_Width_ = 0.3f;
        /// <summary>
        /// Shader property ID.
        /// </summary>
        public static int _Circle_Width_ID = Shader.PropertyToID("_Circle_Width_");
        /// <summary>
        /// Shader property.
        /// </summary>;
        [Range(0f, 1f)] public float _Filled_Fraction_ = 0.1f;
        /// <summary>
        /// Shader property ID.
        /// </summary>
        ...
        public override void InitializeFromMaterial(Material material)
        {
            ...
            _Circle_Color_ = material.GetColor(_Circle_Color_ID);
            _Fill_1_ = material.GetColor(_Fill_1_ID);
            _Fill_2_ = material.GetColor(_Fill_2_ID);
            _Circle_Width_ = material.GetFloat(_Circle_Width_ID);
        ...
        public override void ApplyToMaterial(Material material)
        {
            ...
            material.SetColor(_Circle_Color_ID, _Circle_Color_);
        ...
        {
            return "Graphics Tools/Canvas/Radial Spinner";
        }
    }
}
