...
{
    /// <summary>
    /// To improve parity with the Unity Standard shader per pixel metallic, smoothness, emissive, and occlusion values can 
    /// all be controlled via channel packing. The TextureCombinerWindow is used to generate channel map textures without 
    /// having to combine textures by hand.
    /// 
    /// This window can be automatically filled out by selecting a Unity Standard shader and clicking "Autopopulate from Standard Material." 
    /// 
    /// Or, you can manually specify a texture (or constant value) per red, green, blue, or alpha channel. The texture 
    /// combination is GPU accelerated and does not require the input texture to be CPU accessible.
    /// </summary>
    public class TextureCombinerWindow : EditorWindow
    {
        ...
        [MenuItem("Window/Graphics Tools/Texture Combiner")]
        ...
        private void Save()
        {
            ...
            Material channelPacker = new Material(Shader.Find("Hidden/Graphics Tools/Texture Combiner"));
