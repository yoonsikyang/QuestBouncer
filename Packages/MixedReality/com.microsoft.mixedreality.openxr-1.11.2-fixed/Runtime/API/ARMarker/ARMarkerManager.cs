...
{
    using MRXRMarker = Microsoft.MixedReality.OpenXR.ARSubsystems.XRMarker;
    using MRXRMarkerSubsystem = Microsoft.MixedReality.OpenXR.ARSubsystems.XRMarkerSubsystem;
    using MRXRMarkerSubsystemDescriptor = Microsoft.MixedReality.OpenXR.ARSubsystems.XRMarkerSubsystemDescriptor;
    ...
    public sealed class ARMarkerManager : ARTrackableManager<
        MRXRMarkerSubsystem,
        MRXRMarkerSubsystemDescriptor,
        MRXRMarkerSubsystem.Provider,
        MRXRMarker,
        ARMarker>
    {
